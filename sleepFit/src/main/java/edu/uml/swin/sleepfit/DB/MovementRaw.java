...
@DatabaseTable(tableName = "movementraw")
public class MovementRaw implements Serializable {
	
	private static final long serialVersionUID = 31415926535897933L;
	...
	public MovementRaw(long mills) {
		this.createTime = new Date(mills);
		this.data = "";
		this.uploaded = false;
	}
	
	public MovementRaw(long mills, ArrayList<Float> rawData) {
		this.createTime = new Date(mills);
	...
	public String toString() {
		...
		strBuf.append(", ").append("MovementData = ").append(data);
