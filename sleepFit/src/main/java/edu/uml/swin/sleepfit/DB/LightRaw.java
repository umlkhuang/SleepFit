...
@DatabaseTable(tableName = "lightraw")
public class LightRaw implements Serializable {
	
	private static final long serialVersionUID = 31415926535897934L;
	...
	public LightRaw(long mills) {
		this.createTime = new Date(mills);
		this.data = "";
		this.uploaded = false;
	}
	
	public LightRaw(long mills, ArrayList<Float> rawData) {
		this.createTime = new Date(mills);
	...
	public String toString() {
		...
		strBuf.append(", ").append("LightData = ").append(data);
